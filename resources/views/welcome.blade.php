        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <a href="{{ url('/en') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">English</a>
                    <a href="{{ url('/cn') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">中文</a>
                    @auth
