        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route(Route::currentRouteName(), 'cn')">
                            中文
                        </x-dropdown-link>

                        <x-dropdown-link :href="route(Route::currentRouteName(), 'en')">
                            English
                        </x-dropdown-link>
                    </x-slot>
                </x-dropdown>
...
<!-- 
 ...
 -->
                        <x-dropdown-link :href="route('multilingual', app()->getLocale())">
                            {{ __('Multi-lingual') }}
                        </x-dropdown-link>
